<template>
  <q-layout view="lHh Lpr lff">
    <q-header elevated>
      ...
      <q-tabs dense align="center" class="bg-white text-secondary">
        <q-route-tab :to="{ name: 'pizzas' }" label="Pizzas" />
        <q-route-tab :to="{ name: 'sobremesas' }" label="Sobremesas" />
        <q-route-tab :to="{ name: 'bebidas' }" label="Bebidas" />
      </q-tabs>
    </q-header>
      ...
      <q-toolbar class="justify-center q-pb-lg">
        <div class="col col-md-10 col-lg-6">
          <div class="row items-center">
            ...
            <p class="text-bold text-grey-6">DAMA'S PIZZA BRASIL, Av. das Américas, 500 - Bloco 7 – 3º andar –
